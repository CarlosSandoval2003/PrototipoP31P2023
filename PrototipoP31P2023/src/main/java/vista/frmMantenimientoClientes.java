...
public class frmMantenimientoClientes extends javax.swing.JInternalFrame {
    ...
    public void llenadoDeCombos() {
     ...
     public void llenadoDeTablas() {
        ...
        List<clsClientes> listaAlum = vendedores.getListadoVendedores();
        tablaUsuarios.setModel(modelo);
        String[] dato = new String[6];
        for (int i = 0; i < listaAlum.size(); i++) {
            dato[0] = listaAlum.get(i).getCodigoVendedores();
            dato[1] = listaAlum.get(i).getNombreVendedores();
            dato[2] = listaAlum.get(i).getDireccionVendedores();
            dato[3] = listaAlum.get(i).getTelefonoVendedores();
            dato[4] = listaAlum.get(i).getNitVendedores();
            dato[5] = listaAlum.get(i).getEstatusVendedores();
            modelo.addRow(dato);
        }       
    }
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(layout.createSequentialGroup()
                                        .addComponent(txtEstatus, javax.swing.GroupLayout.PREFERRED_SIZE, 279, javax.swing.GroupLayout.PREFERRED_SIZE)
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(label1)
                        .addGap(294, 595, Short.MAX_VALUE))
                    .addGroup(layout.createSequentialGroup()
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        clsClientes vendedores = new clsClientes();
        vendedores.setCodigoVendedores(txtbuscado.getText());
        registrosBorrados=vendedores.setBorrarVendedores(vendedores);
    ...
    private void btnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarActionPerformed
        clsClientes vendedores = new clsClientes();
        vendedores.setCodigoVendedores(txtCarnet.getText());
        vendedores.setNombreVendedores(txtNombre.getText());
        vendedores.setDireccionVendedores(txtDireccion.getText());
        vendedores.setTelefonoVendedores(txtTelefono.getText());
        vendedores.setNitVendedores(txtEmail.getText());
        vendedores.setEstatusVendedores(txtEstatus.getText());
        vendedores.setIngresarVendedores(vendedores);
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        ...
        vendedores.setCodigoVendedores(txtbuscado.getText());        
        vendedores = vendedores.getBuscarInformacionVendedoresPorCodigo(vendedores);
        System.out.println("Alumno retornado:" + vendedores);   
        txtCarnet.setText(vendedores.getCodigoVendedores());
        txtNombre.setText(vendedores.getNombreVendedores());
        txtDireccion.setText(vendedores.getDireccionVendedores());
        txtTelefono.setText(vendedores.getTelefonoVendedores());
        txtEmail.setText(vendedores.getNitVendedores());
        txtEstatus.setText(vendedores.getEstatusVendedores());
...
//        // TODO add your handling code here:
        ...
        vendedores.setNitVendedores(txtEmail.getText());
        vendedores.setEstatusVendedores(txtEstatus.getText());
        vendedores.setModificarVendedores(vendedores);
