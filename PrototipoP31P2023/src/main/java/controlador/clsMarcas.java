...
public class clsMarcas {
    ...
    public clsMarcas(String CodigoMarca, String NombreMarca, String EstatusMarca) {
    ...
    public String toString() {
        return "clsMarcas{" + "CodigoMarca=" + CodigoMarca + ", NombreMarca=" + NombreMarca + ", EstatusMarca=" + EstatusMarca + '}';
    }
